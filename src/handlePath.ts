...
/**
 * @example <caption>Escape whitespace for setting kshdb arguments with spaces</caption>
 * escapeCharactersInKshdbArg("/pa th/to/script.sh");
 * // => "/pa\\\\040th/to/script.sh"
 */
export function escapeCharactersInKshdbArg(path: string): string {
